...
var getSortedNodes = function (nodes, order, importOrderSeparation) {
    ...
    if (firstNodesComments) {
        var firstNodesLastComment = firstNodesComments[firstNodesComments.length - 1];
        var totalNewLines = (((_b = (_a = nodes[0]) === null || _a === void 0 ? void 0 : _a.loc) === null || _b === void 0 ? void 0 : _b.start.line) || 0) - firstNodesLastComment.loc.end.line - 1;
        if (totalNewLines > 0) {
            allSortedNodes.unshift(constants_1.newLineNode);
        }
